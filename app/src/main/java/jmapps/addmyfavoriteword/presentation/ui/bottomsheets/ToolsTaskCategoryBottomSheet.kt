...
class ToolsTaskCategoryBottomSheet : BottomSheetDialogFragment(),
    ...
    companion object {
        ...
        const val ARG_TASK_CATEGORY_ADD_DATE_TIME = "arg_task_category_add_date_time"
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        val lastTaskCategoryAddDateTimeSwitch = sharedLocalPreferences.getBooleanValue(ARG_TASK_CATEGORY_ADD_DATE_TIME, false)
    ...
    override fun onCheckedChanged(buttonView: CompoundButton?, isChecked: Boolean) {
        when (buttonView?.id) {
            R.id.switch_add_task_category_time -> {
                sharedLocalPreferences.saveBooleanValue(ARG_TASK_CATEGORY_ADD_DATE_TIME, isChecked)
            }
            R.id.switch_change_task_category_time -> {
                sharedLocalPreferences.saveBooleanValue(ARG_TASK_CATEGORY_CHANGE_DATE_TIME, isChecked)
            }
        }
    }
}